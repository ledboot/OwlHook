...
func Init(ctx context.Context) {
	s := &sNotify{}
	var notifyCfgMap = map[consts.Platform]*model.PlatformConfig{}
...
func (s *sNotify) Send(ctx context.Context, platform consts.Platform, message *model.WebhookMessage) error {
